...
function M.setup(colors)
	...
	hi.TabLine = { guifg = M.colors.base03, guibg = M.colors.base00, gui = "none", guisp = nil }
	hi.TabLineFill = { guifg = M.colors.base03, guibg = M.colors.base00, gui = "none", guisp = nil }
